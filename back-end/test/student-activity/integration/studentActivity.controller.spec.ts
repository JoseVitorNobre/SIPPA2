...
import { StudentActivityController } from '../../../src/interfaces/http/controllers/student-activity.controller';
...
describe('GeneralNewService', () => {
    let controller: StudentActivityController;
    ...
    beforeEach(async () => {
      ...
      controller = module.get<StudentActivityController>(StudentActivityController);
    });
    ...
    describe('GET methods', () => {
      it('should return a list of activities of a student', async () => {
        ...
        const activities = await controller.findStudentActivities(student_id);
      ...
      it('should return details of a studentActivity', async () => {
        ...
        expect(await controller.findStudentActivities(studentActivity_id)).resolves;
      });
      ...
      it('should return a 404 if studentActivity is not found', async () => {
        ...
        await expect(controller.findOneStudentActivity(studentActivity_id)).rejects.toThrow(NotFoundException);
      });
    });
  });
